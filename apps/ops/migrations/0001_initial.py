    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('adhoc', 'Adhoc'), ('playbook', 'Playbook'), ('upload_file', 'Upload File'), ('download_file', 'Download File')], default='adhoc', max_length=128, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.CharField(choices=[('adhoc', 'Adhoc'), ('playbook', 'Playbook'), ('upload_file', 'Upload File'), ('download_file', 'Download File')], default='adhoc', max_length=128, verbose_name='Material Type')),
            ],
            options={
