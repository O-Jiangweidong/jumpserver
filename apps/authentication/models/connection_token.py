    ...
    def is_valid(self) -> bool:
        ...
        if self.asset.is_offline:
            raise PermissionDenied(
                _('This asset is under maintenance. Please contact {}  (maintenance staff) for assistance. Meanwhile, refresh the current page to check the device status').format(self.asset.maintainer)
            )
