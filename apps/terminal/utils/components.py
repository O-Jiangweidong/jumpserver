...
class ComponentsPrometheusMetricsUtil(TypedComponentsStatusMetricsUtil):
    ...
    def get_component_status_metrics(self):
        ...
        status_metric_text = 'toecsec_components_status_total{component_type="%s", status="%s"} %s'
    ...
    def get_component_session_metrics(self):
        ...
        session_active_metric_text = 'toecsec_components_session_active_total{component_type="%s"} %s'
    ...
    def get_component_stat_metrics(self):
        ...
        state_metric_text = 'toecsec_components_%s{component_type="%s", component="%s"} %s'
        stats_key = [
