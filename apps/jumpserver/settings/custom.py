...
MIDDLEMAN_ENDPOINT = CONFIG.MIDDLEMAN_ENDPOINT
MIDDLEMAN_SERVICE_NAME = CONFIG.MIDDLEMAN_SERVICE_NAME
MIDDLEMAN_SELF_ENDPOINT = CONFIG.MIDDLEMAN_SELF_ENDPOINT
MIDDLEMAN_SERVICE_DISPLAY = CONFIG.MIDDLEMAN_SERVICE_DISPLAY
MIDDLEMAN_SERVICE_ROLE_NAME = CONFIG.MIDDLEMAN_SERVICE_ROLE_NAME  # master/slave
MIDDLEMAN_IGNORE_SAME_NAME = CONFIG.MIDDLEMAN_IGNORE_SAME_NAME
